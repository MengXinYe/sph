        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="item in skuInfo.skuAttrValueList"
                  :key="item.attrId">
                <dt class="title">{{ item.attrName }}</dt>
                <dd changepirce="0"
                    class="active">{{ item.valueName }}</dd>
              </dl>
              <dl v-for="item in skuInfo.skuSaleAttrValueList"
                  :key="item.saleAttrId">
                <dt class="title">{{ item.saleAttrName }}</dt>
                <dd changepirce="0"
                    class="active">{{ item.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
              ...
              <template>
                <el-button :plain="true"
                           class="add"
                           @click="addedShoppingCart(skuInfo.id, skuNum)"
                           ref="err"> <a href="javascript:">加入购物车</a></el-button>
              </template>
            </div>
          </div>
        </div>
...
import ImageList from './ImageList/MXImageList'
import Zoom from './Zoom/MXZoom'
...
export default {
  ...
  methods: {
    ...
    addedShoppingCart(id, num) {
      this.$store
        .dispatch('addShopCart', { skuId: id, skuNum: num })
        .then(() => {
